...
本仓库是一个本地 Skills 示例集合，当前重点提供视频转字幕能力，并已配置 Marketplace 入口。
...
当前已提供：
- `skills/video-to-srt`：从视频链接下载媒体并生成 `.srt` 字幕文件
...
2. 安装 `local-agent-skills` 中的 `video-processing-skills`
3. 调用技能时，按 `skills/video-to-srt/SKILL.md` 提供视频 URL 参数
